...
var DataService = /** @class */ (function () {
    function DataService(bingHttp) {
        this.bingHttp = bingHttp;
        this.url = 'https://s21achusvcev01blkbapp01.sky.blackbaud.com/v1/';
        // private bingMapsKey = 'AvBJOqM5TW1BNY-cPJQyTU9GL99cra2jFwXQqR5brPf9mjaYMQSJ6xGD7hASgiBe';
        this.bingMapsKey = 'Av9NjnrAYydrGSUsGyzroX6cTULvo0HDs06JUiO3BOa9I1evHdVL54FwrbUNcFKS'; // taken from skyux-libs-event-components
    }
    DataService.prototype.getLocation = function (address) {
        var bingLocationResponse;
        var bingUrlUS = "https://dev.virtualearth.net/REST/v1/Locations/US/" + address + "?output=json&maxRes=20&key=" + this.bingMapsKey;
        var res = this.bingHttp.get(bingUrlUS, this.requestOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) {
...
module.exports = ".map-container { height: 100%; }\n.map-content { display: block; }\n.description { margin-top: 10px; padding: 15px; background-color: bisque; border: 1px solid orange; }\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<i class=\"fa\"></i>\n<div style=\"height: 100%; width: 100%;\">\n  <x-map #xmap\n    [Options]=\"_options\"\n    [Box]=\"_box\">\n    <x-map-marker *ngFor=\"let m of _markers; let i=index\"\n      [Latitude]=\"m.latitude\"\n      [Longitude]=\"m.longitude\"\n      [Title]=\"addresses[i].name\"\n      [IconInfo]=\"_iconInfo\">\n      <x-info-box [DisableAutoPan]=\"true\"\n        [Title]=\"addresses[i].name\"\n        [Description]=\"addresses[i].address\">\n      </x-info-box>\n    </x-map-marker>\n  </x-map>\n</div>"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var angular_maps__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! angular-maps */ "./node_modules/angular-maps/fesm5/angular-maps.js");
/* harmony import */ var _address_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./address_service */ "./src/app/address_service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppComponent = /** @class */ (function () {
    function AppComponent(addressService) {
        this._markerTypeId = angular_maps__WEBPACK_IMPORTED_MODULE_1__["MarkerTypeId"];
        this._options = {
        ...
        this._iconInfo = {
            markerType: angular_maps__WEBPACK_IMPORTED_MODULE_1__["MarkerTypeId"].FontMarker,
    ...
    AppComponent.prototype.updateMap = function (addressService) {
        var _this = this;
        this.addresses.forEach(function (address) {
            addressService.getLocation(address.address).subscribe(function (bingLocationResponse) {
                var lat = 0;
                var long = 0;
                bingLocationResponse.resourceSets.forEach(function (resourceSet) {
                    resourceSet.resources.forEach(function (resource) {
                ...
                _this._markers.push({ latitude: lat, longitude: long });
            });
        });
    };
    AppComponent.prototype._click = function (index) {
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_address_service__WEBPACK_IMPORTED_MODULE_2__["DataService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/*!*******************************!*\
  !*** ./src/app/app.module.ts ***!
  \*******************************/
/*! exports provided: MapServiceProviderFactory, AppModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MapServiceProviderFactory", function() { return MapServiceProviderFactory; });
...
/* harmony import */ var angular_maps__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! angular-maps */ "./node_modules/angular-maps/fesm5/angular-maps.js");
/* harmony import */ var _address_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./address_service */ "./src/app/address_service.ts");
...
function MapServiceProviderFactory() {
    var bc = new angular_maps__WEBPACK_IMPORTED_MODULE_5__["BingMapAPILoaderConfig"]();
    bc.apiKey = "AvBJOqM5TW1BNY-cPJQyTU9GL99cra2jFwXQqR5brPf9mjaYMQSJ6xGD7hASgiBe"; // your bing map key
    bc.branch = "experimental";
    // to use the experimental bing brach. There are some bug fixes for
    // clustering in that branch you will need if you want to use 
    // clustering.
    return new angular_maps__WEBPACK_IMPORTED_MODULE_5__["BingMapAPILoader"](bc, new angular_maps__WEBPACK_IMPORTED_MODULE_5__["WindowRef"](), new angular_maps__WEBPACK_IMPORTED_MODULE_5__["DocumentRef"]());
}
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], angular_maps__WEBPACK_IMPORTED_MODULE_5__["MapModule"].forRoot(), _angular_http__WEBPACK_IMPORTED_MODULE_7__["HttpModule"]],
            providers: [
                {
                    provide: angular_maps__WEBPACK_IMPORTED_MODULE_5__["MapAPILoader"], deps: [], useFactory: MapServiceProviderFactory
                }, _address_service__WEBPACK_IMPORTED_MODULE_6__["DataService"]
            ],
...
module.exports = __webpack_require__(/*! /Users/steven.draugel/code/lindsey/family-locator/src/main.ts */"./src/main.ts");
